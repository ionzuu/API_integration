...
function showInfo(getInfo, currentLocation){
    ...
    main.innerHTML = `  
        <div class="temp"><img src="/img/sunny.png"><h3 class='title-header'>Temperature: ${getInfo?.current.temperature_2m}°</h3></div><div class="locate"><img src="/img/world.png"><h3 class='title-header'>Latitude: ${currentLocation.lat} <br> Longitude: ${currentLocation.lon}</h3></div>
