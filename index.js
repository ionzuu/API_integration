...
function showInfo(getInfo, currentLocation){
    ...
    main.innerHTML = `  
        <div class="temp"><img src="API_integration/img/sunny.jpg"><h3 class='title-header'>Temperature: ${getInfo?.current.temperature_2m}°</h3></div><div class="locate"><img src="/img/world.png"><h3 class='title-header'>Latitude: ${currentLocation.lat} <br> Longitude: ${currentLocation.lon}</h3></div>
        <div class="wind"><img src="img/wind.webp"><h3 class='title-header'>Wind speed: ${getInfo?.current.wind_speed_10m} mph</h3></div>
    `
}
